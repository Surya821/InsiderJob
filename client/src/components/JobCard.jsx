...
const jobCard = ({job}) => {
    ...
    return (
        <div className='border border-gray-300 p-6 shadow rounded'>
            ...
            <button onClick={()=> {navigate(`/apply-job/${job._id}`); scrollTo(0,0); }} className='bg-gray-100 border border-gray-500 px-4 py-2 rounded cursor-pointer'>Learn More</button>
            </div>
        </div>
    )
}
