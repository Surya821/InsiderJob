            ...
            {applicants.filter(item => item.jobId && item.userId).map((applicant, index)=> (
              <tr key={index} className='text-gray-700'>
                ...
                <td className='py-2 px-4 border-b border-gray-200 '>
                  <a className='bg-blue-50 tex-blue-400 px-3 py-1 rounded inline-flex gap-2 items-center' href={applicant.userId.resume} target='_blank'>
                ...
                <td className='py-2 px-4 border-b border-gray-200 relative'>
                  {applicant.status === 'Pending' ? <div className='relative inline-block text-left group'>
                    ...
                    <div className='z-10 hidden absolute right-0 md:left-0 top-0 mt-2 w-32 bg-white border border-gray-200 roundedshadow group-hover:block'>
