        ...
        <div className='flex gap-2 mb-6 mt-3 '>
          {
            ...
            ? <>
              ...
              <button onClick={e=> setIsEdit(false) } className='cursor-pointer bg-green-100 border-green-400 rounded-lg px-4 py-2'>Save</button>
            </> 
          ...
          <tbody>
            {
              jobsApplied.map((job,index)=> true ? (
                <tr>
                  ...
                  <td className='py-2 px-4 border-b border-gray-300 max-sm:hidden'>{job.title}</td>
