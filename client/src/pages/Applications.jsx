        ...
        <div className='flex gap-2 mb-6 mt-3 '>
          {
            ...
            ? <>
              ...
              <button onClick={updateResume} className='cursor-pointer bg-green-100 border-green-400 rounded-lg px-4 py-2'>Save</button>
            </> 
            : <div className='flex gap-2'>
              <a className='bg-blue-100 text-blue-600 px-4 py-2 rounded-lg' target='_blank' >
                Resume
              </a>
          ...
          <tbody>
            {
              userApplication.map((job,index)=> true ? (
                <tr key={index}>
                  ...
                  <td className='py-2 px-4 border-b border-gray-300 max-sm:hidden'>{job.jobId.title}</td>
